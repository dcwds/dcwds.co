      ...
      <div className="py-6">
        ...
        <div className="content-block text-sm md:grid grid-cols-2 gap-6">
          <div>
            ...
            <p>
              At Rule, I was solely responsible for branding, marketing sites,
              and the product UI for web and mobile. We were acquired in 2013 by
              the productivity SaaS startup, Glip.
            </p>
          </div>
          <div>
            <p>
              A lot of my growth as a front-end developer happened at Glip,
              where I was expected to implement my design work into our product.
            </p>

            <p>
              In the subsequent years after Glip was acquired in late 2015, I
              had the opportunity to further develop my front-end skills through
